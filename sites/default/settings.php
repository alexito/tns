 ...
 *
 */
$drupal_hash_salt = '9liGJHUgZlmrOWyYQTpu7hFCIKogb7LLyitQBErnklo';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_tns_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_tns_dd.inc';
}
// </DDSETTINGS>
